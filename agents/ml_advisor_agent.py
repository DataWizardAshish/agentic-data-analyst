...
"""
import dspy
from signatures.dspy_signatures import MLUseCaseDetector, FeatureEngineeringPlanner
...
class MLAdvisorAgent:
    ...
    def analyze(self, schema_results: dict, profile_results: dict, quality_results: dict) -> dict:
        """
        ...
        try:
            column_summary = self._create_column_summary(schema_results, profile_results)
    ...
    def _create_column_summary(self, schema_results: dict, profile_results: dict) -> str:
        ...
        summary_lines = []
        for col in columns:
            line = f"- {col['column_name']}: {col['business_type']}, {col['pandas_dtype']}"
